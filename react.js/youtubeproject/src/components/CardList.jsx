                    ...
                    <div key={i} className="">
                        ...
                        <div className="flex items-start gap-3 mt-3">
                            ...
                            <div className="flex-1">
                                <h1 className="text-lg font-bold text-black">Video Title</h1>
                                <h3 className="text-sm font-semibold text-gray-800">Lorem ipsum dolor sit amet, consectetuer adipiscing elit</h3>
